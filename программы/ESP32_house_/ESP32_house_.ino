...
String date() {
  ...
  String date = String(String(dateTime.substring(0, 4).toInt()) + "-" + String(dateTime.substring(5, 7).toInt()) + "-" + String(dateTime.substring(8, 10).toInt()) + " " + String(dateTime.substring(11, 13).toInt()) + ":" + String(dateTime.substring(14, 16).toInt()) + ":" + String(dateTime.substring(17, 19).toInt()));
